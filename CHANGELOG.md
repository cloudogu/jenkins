...
## [Unreleased]
### Changed
- [#285] Update Jenkins to 2.576
  - this version fixes multiple CVEs
...
### Changed
- [#273] Upgrade Jenkins to v2.555.3
- [#273] Upgrade Java base-image to v21.0.11-2
...
### Changed
- [#244] Localization and packet handling improvements
...
### Changed
- [#237] Update Jenkins to 2.528.3
- [#237] Revert Base Image to `17.0.13-1`
- [#237] Removed optional OpenJDK 17 to
- [#237] Reverted optional OpenJDK 11 to `11.0.28_p6-r0`
