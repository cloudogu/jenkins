...
## [Unreleased]
### Changed
- Upgrade Jenkins to v2.555.3
- Upgrade Java base-image to v21.0.11-2
...
* Updated OpenJDK 17 for tooling to version 17.0.19_p10-r0
* Updated OpenJDK 25 for tooling to version 25.0.3_p9-r1
...
### Security
* [#259] CVE fixed [cve-2025-68121](https://nvd.nist.gov/vuln/detail/cve-2025-68121)
...
### Added
* Integration for starting Jenkins agents on Kubernetes
...
* Removal of the optional OpenJDK 17 version `17.0.17_p10`
* Updated the optional OpenJDK 11 to version`11.0.28_p6-r0`

## [v2.528.1-2] - 2025-11-06
### Changed
* Add the optional OpenJDK 17 in version `17.0.17_p10`
* Update the optional OpenJDK 11 to version `11.0.29_p7`

## [v2.528.1-1] - 2025-10-20
### Changed
* The Dogu now provides the Jenkins version 2.528.1. You can find the Jenkins release notes [here](https://www.jenkins.io/changelog/2.528.1).
