    ...
    timestamps {
        properties([
            ...
            parameters([
                ...
                choice(name: 'TrivySeverityLevel', choices: [TrivySeverityLevel.CRITICAL, TrivySeverityLevel.HIGH, TrivySeverityLevel.MEDIUM, TrivySeverityLevel.ALL], description: 'The severity levels to scan with trivy'),
